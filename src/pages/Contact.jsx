    ...
    <>
      <div className="contact section max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-center relative">
          <img src={Pattern3} alt="" className="absolute right-0 top-1/2 transform -translate-y-1/2  opacity-20" />
          ...
          <img src={Pattern2} alt="" className="absolute left-0 top-1/2 transform -translate-y-1/2  opacity-20" />
        </div>
