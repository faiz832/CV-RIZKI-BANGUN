  ...
  return (
    <>
      <div className="relative overflow-hidden">
        <img src={Pattern} alt="" className="absolute right-0 top-0 w-40 h-auto -rotate-45 -z-1 opacity-10" />
        ...
        <div className="contact section max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="relative text-6xl w-max mx-auto font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-green-700 to-green-400 my-12">
            <img src={Pattern2} alt="" className="absolute top-0 -right-28 w-24 opacity-20" />
            Contact Us
            <img src={Pattern3} alt="" className="absolute top-0 -left-28 w-24 opacity-20" />
          </div>
