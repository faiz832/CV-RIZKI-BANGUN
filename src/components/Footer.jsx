            ...
            <div className="flex gap-4 justify-start lg:justify-end items-end">
              {[
                ...
                },
                {
                  ...
                  icon: <path d="M18.901 1.153h3.68l-8.04 9.557L24 22.846h-7.406l-5.8-7.584-6.638 7.584H1.476l8.624-9.824L0 1.153h7.594l5.243 6.932L18.901 1.153Zm-1.264 19.847h2.031L5.523 3.214H3.342L17.637 21Z" />,
                },
              ].map(({ name, url, icon }) => (
                <a key={name} href={url} target="_blank" rel="noopener noreferrer" className="group relative h-fit transition-all duration-200 ease-[cubic-bezier(0.68,-0.55,0.265,1.55)] p-2 rounded-full bg-white">
